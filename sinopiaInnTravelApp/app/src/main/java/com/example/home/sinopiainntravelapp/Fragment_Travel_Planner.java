...
public class Fragment_Travel_Planner extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        travelerrormessage = (TextView) rootView.findViewById(R.id.travelerrormessage);
        ...
        placesofinterest.setOnClickListener(new View.OnClickListener() {
                                                ...
                                                public void onClick(View v) {
                                                    ...
                                                    if(bundle.getInt("Activity") == 0){
                                                        ...
                                                        if (((Activity_Home) getActivity()).JsonBusinesses.length() != 0) {
                                                        ...
                                                        if (((Activity_CheckIn) getActivity()).JsonBusinesses.length() != 0) {
        ...
        amenities.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(bundle.getInt("Activity") == 0){
                    ...
                    if(((Activity_Home) getActivity()).businessTypeList.size() != 0)

                    {
                        ...
                        travelerrormessage.setText("Select speacial interests to continue.");

                    }
                }else {

                    if(((Activity_CheckIn) getActivity()).businessTypeList.size() != 0) {
                ...
                Fragment_Bill new_fragment_bill = new Fragment_Bill();
                    ...
                    if(getArguments().getInt("Activity") == 0) {
                        ...
                        if ( ((Activity_Home) getActivity()).itinerary.length() != 0) {
                            ...
                            errormessage.setError("... and thats it. Once you've confirmed a room , we,ll add your trip to you bill.");
                            ...
                            errormessage.setError("You need to choose your places of interest ");
                            travelerrormessage.setText("You need to choose your places of interest .");
                        }
                        ...
                        if ( ((Activity_CheckIn) getActivity()).itinerary.length() != 0) {
                          ...
                          ((Activity_CheckIn) getActivity()).onBraintreeSubmit();
                            ...
                            errormessage.setError("You need to choose your places of interest to continue ");
                            travelerrormessage.setText("You need to choose your places of interest to continue.");
